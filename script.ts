interface ResumeData {
  ...
  function generateResume() {
    const ResumeHTML = `
      ...
      <p class='out'><b>Name:</b> ${ResumeForm.name}</p>
      <p class='out'><b>Email:</b> ${ResumeForm.email}</p>
      <p class='out'><b>Phone:</b> ${ResumeForm.phone}</p>
      <p class='out'><b>Address:</b> ${ResumeForm.address}</p><hr>
      <h2>Education</h2>
      <p class='out'><b>Degree:</b> ${ResumeForm.degree}</p>
      <p class='out'><b>Institute:</b> ${ResumeForm.institute}</p><hr>
      <h2>Skills</h2>
      <p class='out'>${ResumeForm.skills}</p>
      <p class='out'>${ResumeForm.skills}</p>
      <p class='out'>${ResumeForm.skills}</p><hr>
      <h2>Work Experience</h2>
      <p class='out'>${ResumeForm.experience}</p>
    `;
